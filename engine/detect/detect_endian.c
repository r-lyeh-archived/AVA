...
API uint16_t swap16ifle( uint16_t x );
API uint32_t swap32ifle( uint32_t x );
API uint64_t swap64ifle( uint64_t x );

API uint16_t swap16ifbe( uint16_t x );
API uint32_t swap32ifbe( uint32_t x );
API uint64_t swap64ifbe( uint64_t x );
...
uint16_t swap16ifle( uint16_t x ) { return is_little ? swap16(x) : x; } // aka ntoh16, hton16
uint32_t swap32ifle( uint32_t x ) { return is_little ? swap32(x) : x; } // aka ntoh32, hton32
uint64_t swap64ifle( uint64_t x ) { return is_little ? swap64(x) : x; } // aka ntoh64, hton64
